...
If you are experienced at this, you may wish to simply just head to [jcmvbkbc's instructions at wiki.osll.ru](http://wiki.osll.ru/doku.php/etc:users:jcmvbkbc:linux-xtensa:esp32s3) 
or [ESP32DE/Boot-Linux-ESP32S3-Playground](https://github.com/ESP32DE/Boot-Linux-ESP32S3-Playground).

Me, I'm a Windows developer at the day job. Most of my Linux activity these days is on WSL, not a "real" Linux box.
I needed some assistance on building a Linux kernel, particularly for an embedded device. Big thanks to [eMbeddedHome](https://twitter.com/gojimmypi/status/1667795889392603136) 
