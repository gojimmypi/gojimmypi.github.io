...
description: "Create an embedded UART SSH Server on the Adafruit Huzzah ESP8266. Securely connect to Tx/Rx serial pins from your network via WiFi. [Source code](https://github.com/gojimmypi/wolfssh/tree/ESP8266_Development/examples/ESP8266-SSH-Server) is available on GitHub."
date: '2022-05-01'
author: gojimmypi
tags:
- SSH
