...
description: "Various tips and reminders when developing for the ESP32. Problem: Forgot how to program with idf. Solution: {% include code_header.html %} ```bash cd ~/esp/esp-idf . $HOME/esp/esp-idf/export.sh idf.py -p"
date: '2021-11-06'
author: gojimmypi
tags:
- ESP32
